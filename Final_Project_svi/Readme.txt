...
To pipe output of ./svi into a file:
./svi commands.txt < input.txt > myOutput.txt
...
Three types of line range specifications
    ...
    <1st line number>,<last line number>/-This format specifies all lines in the range <1st line number> to <last line number>, inclusive. 
...
s/<old text>/<new text>/
    ...
    first occurrence of .pas with .c, in all lines containing filename. The <old text> and <new text> can be maximally 80 characters. 
